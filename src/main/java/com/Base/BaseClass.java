...
//	}
	...
	protected void screenShot(WebDriver driver, String name) {
		...
		File destfile = new File(
				"C:\\Users\\jayaa\\OneDrive\\Desktop\\testing\\AmazonProject\\AmazonProject\\ScreenShots\\" + name
						+ ".png");
		try {
	...
	protected String takeScreenShot() {
		...
		File scrfile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		File destfile = new File(
				"C:\\Users\\jayaa\\OneDrive\\Desktop\\testing\\AmazonProject\\AmazonProject\\ScreenShots\\" + timeStamp
						+ ".png");
		try {
			FileHandler.copy(scrfile, destfile);
		} catch (IOException e) {
